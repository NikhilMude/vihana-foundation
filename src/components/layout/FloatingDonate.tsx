...
export default function FloatingDonate({ content }: { content: SiteContent }) {
  ...
  return (
    <SmartNavLink
      ...
      className="fixed bottom-3 right-3 z-50 inline-flex h-11 w-11 items-center justify-center gap-2 rounded-full text-sm font-bold shadow-2xl shadow-slate-900/20 sm:bottom-5 sm:right-5 sm:h-12 sm:w-auto sm:px-5"
      style={{
