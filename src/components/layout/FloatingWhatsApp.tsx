...
export default function FloatingWhatsApp({ content }: { content: SiteContent }) {
  ...
  return (
    <Link
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-16 right-4 z-50 inline-flex h-11 items-center gap-2 rounded-full bg-emerald-600 px-4 text-sm font-bold text-white shadow-2xl shadow-slate-900/20 hover:bg-emerald-700 sm:bottom-20 sm:right-5 sm:h-12 sm:px-5"
    >
