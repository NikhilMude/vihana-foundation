...
export const defaultSiteContent: SiteContent = {
  ...
  pages: [
    ...
    },
    {
      ...
      imageUrl: "/images/generated/vihana-story-photo.jpg",
      body:
        "This Cookie Policy explains how Vihana Foundation uses cookies and similar technologies on this website.\n\nCookies are small files stored on a visitor's device. They help the website work properly, remember choices, understand basic visitor activity, protect forms from misuse and improve the experience over time.\n\nEssential cookies may be used for website security, consent preferences, admin login, donor login, form submission and other core site functions. These cookies are required for the website to operate reliably.\n\nAnalytics cookies may be used to understand page visits, device type, general location, traffic sources and site performance. This information helps us improve content, accessibility and navigation. Analytics should be used in an aggregated way and not to sell personal information.\n\nThird-party services used for hosting, email delivery, form processing, payment communication, embedded content, maps, media, analytics or security may set their own cookies according to their own policies.\n\nVisitors can choose Accept All, Essential Only or Reject All using the cookie banner. Browser settings may also be used to block or delete cookies. Blocking cookies may affect login, forms, saved preferences, analytics accuracy or embedded services.\n\nCookie choices may be stored locally in the browser so the banner does not appear on every visit. If the browser storage is cleared, the banner may appear again.\n\nWe do not use cookies to sell visitor information. If advertising, remarketing or additional tracking tools are introduced later, this policy should be updated before those tools are enabled.\n\nFor privacy or cookie questions, contact contact@vihanafoundation.org. This policy should be reviewed by a qualified legal advisor before final public launch.",
      buttonLabel: "Contact Us",
      buttonHref: "/contact-us",
      published: true,
    },
