  ...
  annualReports: [
    {
      ...
      value: "FY 2026-27",
      tag: "PDF",
      description: "A public-facing summary of donations, expenses, program priorities, governance notes and verified impact records.",
      linkLabel: "View PDF",
      linkHref: "/documents/annual-impact-report-2026.pdf",
      imageUrl: "/images/generated/vihana-meal-support-photo.jpg",
    },
    {
      id: "financial-summary-2026",
      title: "Financial Transparency Summary",
      value: "FY 2026-27",
      tag: "Excel",
      description: "Category-wise received amounts, expenses, receipts, bills and annual statement information for review.",
      linkLabel: "Open Sheet",
      linkHref: "/documents/financial-summary-2026.xlsx",
      imageUrl: "/images/generated/vihana-story-photo.jpg",
    },
    {
      id: "media-kit-2026",
      title: "Media & Press Reference Kit",
      value: "Public note",
      tag: "Word",
      description: "Foundation overview, program language, contact details and approved summary text for media or partners.",
      linkLabel: "Read Document",
      linkHref: "/documents/media-kit-2026.docx",
      imageUrl: "/images/generated/vihana-hero-photo.jpg",
    },
    {
      id: "presentation-slides-2026",
      title: "Program Presentation Slides",
      value: "Presentation",
      tag: "Presentation",
      description: "A concise slide deck for partners, donors and community presentations.",
      linkLabel: "View Slides",
      linkHref: "/documents/presentation-slides-2026.pdf",
      imageUrl: "/images/generated/vihana-story-photo.jpg",
    },
    {
      id: "registration-pack",
      title: "Registration & Compliance Pack",
      value: "Public link",
      tag: "External Link",
      description: "Registration, PAN, 80G/12A and trust deed references are available via a secure public link.",
      linkLabel: "Open Link",
      linkHref: "https://example.com/vihana-registration-pack",
      imageUrl: "/images/generated/vihana-meal-support-photo.jpg",
    },
    {
      id: "impact-snapshot",
      title: "Impact Snapshot Gallery",
      value: "Image",
      tag: "Image",
      description: "A visual summary of program moments, field activities and community support highlights.",
      linkLabel: "View Image",
      linkHref: "/images/generated/vihana-story-photo.jpg",
      imageUrl: "/images/generated/vihana-story-photo.jpg",
    },
  ],
  teamMembers: [
